...
$cdescrip = mysqli_real_escape_string($conn, $_REQUEST['cdescrip']);


$sql = "INSERT INTO category(cname,cdescription) VALUES ('$cname', '$cdescrip')";
...
<br>
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Description" name="cdescrip">
                </div>
                <br><br>
