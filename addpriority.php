...
$prname = mysqli_real_escape_string($conn, $_REQUEST['prname']);



$sql = "INSERT INTO priority(prname) VALUES ('$prname')";
...
<body class="">
  ...
  <div class="container">
      <div class="row">
        <div class="col-xs-2 col-sm-6 ml-auto mr-auto">
          <div class="card ">
            <form class="form" method="POST" action="">
              ...
              <div class="card-body">
                ...
                <div class="input-group">
                  ...
                  <br><br>
                  <br><input type="text" class="form-control" placeholder="Enter Priority" name="prname">
                </div>
